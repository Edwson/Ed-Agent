...
- **Guardrail components this should map to:** KycStepper (1)
- **Regulatory anchors present:** ASIC AML/CTF
- **Components addressing FATF:** 4 (KycStepper, RegCitation, SanctionsScreen, UboGraph)
- **Token contrast (the system it ships on):** 18 pairs checked · **3 below WCAG AA**
- _WCAG 2.1 relative-luminance contrast. AA = 4.5:1 normal / 3:1 large; AAA = 7:1 normal. Foreground tokens over background_
